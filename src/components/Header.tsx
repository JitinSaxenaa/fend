      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          >
            ...
            <span className="text-xl font-semibold text-gray-900">CureConnect</span>
          </div>
          ...
          <nav className="hidden md:flex space-x-8">
            ...
            <a href="#" className="text-gray-600 hover:text-gray-900 transition-colors">Testimonials</a>
          </nav>
